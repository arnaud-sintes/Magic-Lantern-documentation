...
> [!WARNING]
>
> To shut down here potential useless discussions, we strongly emphases the fact that the *LJ92* compression algorithm used here is truly **<u>lossless</u>**, meaning the following chain of operation:
>
> ```
...
- an **overclock** of the *SD* transfer protocol, up to *160MHz*, *192MHz* or *240MHz* speeds depending on the *SD* card model (please refer to the [*240MHz* compatible cards list](https://wiki.magiclantern.fm/cards_240mhz)), leading to a huge increase in the *SD bus* write speed capabilities
